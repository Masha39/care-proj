...
const Carousel = () => {
  const [items, setItems] = useState([
    ...
    {id: 4,href: '#', image: <Item1/>, tagImage: <Tool/>, tagTitle: 'Tool', textTitle: 'Who is your home care team?' },
    {id: 5,href: '#', image: <Item1/>, tagImage: <Tool/>, tagTitle: 'Tool', textTitle: 'Who is your home care team?' },
    {id: 6,href: '#', image: <Item1/>, tagImage: <Tool/>, tagTitle: 'Tool', textTitle: 'Who is your home care team?' },
  ])
